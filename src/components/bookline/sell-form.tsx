  ...
  return (
    <div className="w-full max-w-[600px] flex flex-col items-center">
        ...
        <div className="w-full bg-secondary rounded-[30px] flex items-stretch mt-4 overflow-hidden">
            ...
            <div className='flex-shrink-0 bg-foreground text-background rounded-l-[30px] px-12 py-4 space-y-1 text-sm flex flex-col justify-center'>
                <p className="w-full text-right">{formatPrice(ebookPrice)}</p>
                <p className="w-full text-right">{formatPrice(netGain)}</p>
                <p className="w-full text-right">{formatPrice(totalPriceForCustomer)}</p>
            </div>
        </div>
    </div>
  );
