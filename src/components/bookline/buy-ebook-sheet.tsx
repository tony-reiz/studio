...
export function BuyEbookSheet({ ebook, open, onOpenChange }: BuyEbookSheetProps) {
  ...
  useEffect(() => {
    ...
    if (open) {
      // Start animation after a short delay to ensure the sheet is visible
      visibilityTimer = setTimeout(() => setIsContentVisible(true), 100);
    } else {
  ...
  const animatedItemClass = (delay: string) => cn(
      ...
      <DrawerContent className="rounded-t-[50px] max-h-[80vh] flex flex-col bg-background p-0 border-0">
        ...
        <div className="overflow-y-auto">
            ...
            <div className="w-full max-w-5xl flex flex-col md:flex-row md:items-start md:justify-center md:gap-4">
                <div className={cn("flex justify-center md:justify-end", animatedItemClass('delay-100'))}>
                    <div className="w-full max-w-[18rem] md:max-w-xs animate-float">
                ...
                <div className="flex justify-center md:justify-start pt-8 md:pt-0">
                    <div className="w-full max-w-[18rem] md:max-w-xs flex flex-col items-center">
                        <div className={cn("w-full", animatedItemClass('delay-200'))}>
                        ...
                        <div className={cn("w-full grid grid-cols-3 gap-2 mb-4", animatedItemClass('delay-[250ms]'))}>
                        ...
                        <div className="w-full space-y-4">
                            <div className={cn("relative w-full", animatedItemClass('delay-[300ms]'))}>
                            ...
                            <div className={cn("relative w-full", animatedItemClass('delay-[350ms]'))}>
                            ...
                            <div className={cn("relative w-full", animatedItemClass('delay-[400ms]'))}>
                        ...
                        <div className={cn("w-full bg-secondary rounded-[30px] grid grid-cols-[1fr_auto] mt-4 overflow-hidden", animatedItemClass('delay-[450ms]'))}>
            ...
            <div className={cn("max-w-[16rem] w-full", animatedItemClass('delay-[500ms]'))}>
                <Button
                ...
                className={cn(
                    ...
                    !isPurchased && isContentVisible && "animate-pulse-subtle"
                )}
                >
