  ...
  return (
    <div className="flex-1 w-full flex flex-col justify-center items-center py-12">
      ...
      >
        ...
        <CarouselPrevious className="text-foreground h-20 w-20 rounded-none absolute left-0 top-1/2 -translate-y-1/2 z-10 border-0 bg-transparent hover:bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0">
          <ChevronLeft size={64} />
        </CarouselPrevious>
        <CarouselNext className="text-foreground h-20 w-20 rounded-none absolute right-0 top-1/2 -translate-y-1/2 z-10 border-0 bg-transparent hover:bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0">
