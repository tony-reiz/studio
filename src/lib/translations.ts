export const translations = {
  fr: {
    ...
    'purchase_of_ebook': 'Achat - "{title}"',
    'sale_of_ebook': 'Vente - "{title}"',
    'pro_subscription': 'Abonnement BookLine Pro',
    'referral_gain': 'Gain parrainage',
    'monthly_statements': 'Vos relevés mensuels',
    'simulated_download': 'Téléchargement simulé',
    ...
    'guide_step1_desc': "Notre système optimise votre file pour une expérience de lecture parfaite, sans altérer la qualité.",
  ...
  en: {
    ...
    'view_documents': 'Documents',
    'purchase_of_ebook': 'Purchase - "{title}"',
    'sale_of_ebook': 'Sale - "{title}"',
    'pro_subscription': 'BookLine Pro Subscription',
    'referral_gain': 'Referral Earning',
    'monthly_statements': 'Your monthly statements',
    'simulated_download': 'Simulated download',
