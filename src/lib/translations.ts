export const translations = {
  fr: {
    ...
    'hero_subtitle': "Libérez votre potentiel. Publiez vos ebooks, partagez votre savoir et générez des revenus en toute simplicité. (Serveur Actif !)",
  ...
  en: {
    ...
    'hero_subtitle': 'Unleash your potential. Publish your ebooks, share your knowledge, and generate income with ease. (Server is Active!)',
